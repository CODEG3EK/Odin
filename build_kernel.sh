...
# very very slightly modified by The CODEG33K for his Twisted S6 kernel       #
#                                                         		      #
###############################################################################
...
if [ ! -f /home/codegeek/Odin/.config ]; then
	echo
	echo "${bldcya}***** Writing Config *****${txtrst}";
	cp /home/codegeek/Odin/arch/arm64/configs/custom_defconfig .config;
	make ARCH=arm64 custom_defconfig;
fi;

. /home/codegeek/Odin/.config
